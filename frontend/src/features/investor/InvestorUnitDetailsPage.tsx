...
export function InvestorUnitDetailsPage() {
  ...
  const filteredFiles = useMemo(() => {
    return files.filter((file) => {
      ...
      if (searchFilter && !file.titulo.toLowerCase().includes(searchFilter.toLowerCase()) && !file.nome_arquivo.toLowerCase().includes(searchFilter.toLowerCase())) return false
      ...
      <div className="hero-banner compact investor-hero investor-detail-hero">
        <div className="investor-detail-hero-main">
          ...
          <div>
            ...
            <p>Consulte documentos por ano, mês, tipo e período, tudo organizado e fácil de navegar.</p>
          </div>
        </div>
      </div>
