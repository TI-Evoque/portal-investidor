...
import { ArrowRight, Building2, CalendarRange, FolderOpen, MapPin } from 'lucide-react'
    ...
    <div>
      <div className="hero-banner compact investor-hero">
        ...
        <div>
          ...
          <p>Abra cada unidade em uma página detalhada para filtrar e organizar seus documentos.</p>
        </div>
      </div>
      ...
      <div className="stats-grid investor-detail-stats">
        ...
        <div className="stat-card orange">
          ...
          <div>
            <div className="stat-title">Anos com documentos</div>
            <div className="stat-value">{new Set(Object.values(filesByUnit).flat().map((file) => file.ano_referencia)).size}</div>
          </div>
        </div>
      </div>
